  ...
  return [
    ...
    },
    {
      ...
      ans: [
        ...
        {
          text: "제발 조합 좀 맞춰..! 팀챗으로 한 명만 탱커해 달라고 협상을 시도한다.",
          point: {
            hardPoint: 3,
            partyPoint: 3,
          },
    ...
    {
      quiz: "일반전 솔플을 도는데, 매칭된 우리 팀원 중 한 명이 계속 우리팀 딜 낮은 딜러에게 욕을 합니다. 어떻게 할까요?",
      ans: [
        {
        ...
        {
          text: "안 그래도 게임 안풀리는데 시끄럽고 짜증난다. 욕하는 애랑 맞서 싸운다.",
          point: {
            fightPoint: 5,
            partyPoint: 1,
            hardPoint: 3,
